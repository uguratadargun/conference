 ...
 * @public
 */
export declare const TrackRefContext: React.Context<TrackReferenceOrPlaceholder>;
/**
 ...
 * @public
 */
export declare function useMaybeTrackRefContext(): TrackReferenceOrPlaceholder;
/**
