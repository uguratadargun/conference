...
// Resolve the background image path at runtime
// The image is located in src/images/virtual-background.jpeg
// Use URL constructor for browser-compatible path resolution
// From src/utils/ to src/images/ directory
const backgroundImagePath = new URL(
  '../images/virtual-background.jpeg',
  import.meta.url
).href;
/** @public */
 ...
 *
 * // Apply virtual background (uses virtual-background.jpeg from images folder)
    ...
    async (
      ...
      try {
        ...
        switch (type) {
          ...
          case 'virtual': {
            try {
              const virtualBgProcessor = VirtualBackground(backgroundImagePath);
